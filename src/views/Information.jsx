    ...
    <div className="pb-[24vw]">
      ...
      <div className="bg-[#f1f1f1] px-[4vw] pb-[10vw]">
        <div className=" relative mt-[-4vw] rounded-[15px] bg-[#fff] w-[92vw] pt-[11vw] pb-[3.8vw] text-center">
          <img src="" alt="" className=" bg-red-200 w-[18vw] h-[18vw] rounded-[50%] absolute top-[-9vw] left-[50%] translate-x-[-50%]" />
          ...
          <div className="h-[11vw] flex items-center justify-center">
            <div className="bg-[#fff] pl-[1.5vw] pr-[1.9vw] pb-[1vw] pt-[0.8vw] text-[#41495E] text-[2vw]  border-[1px] border-[#CCCCCD] rounded-[8px] ml-[1.5vw]">IP:</div>
            <div className="bg-[#fff] pl-[1.5vw] pr-[1.9vw] pb-[1vw] pt-[0.8vw] text-[#41495E] text-[2vw]  border-[1px] border-[#CCCCCD] rounded-[8px] ml-[1.5vw] flex items-center"><Icon icon="iconoir:male" color="#5c9bed" className="text-[3vw] mr-[1vw]" /> 00后 处女座</div>
            <div className="bg-[#fff] pl-[1.5vw] pr-[1.9vw] pb-[1vw] pt-[0.8vw] text-[#41495E] text-[2vw]  border-[1px] border-[#CCCCCD] rounded-[8px] ml-[1.5vw]">村龄 4年</div>
          </div>
          <div className="flex items-center justify-center">
            <div className="px-[3vw] py-[1vw] text-[#41495E] text-[2.9vw] font-[800] flex items-center justify-center border-[1px] border-[#CCCCCD] rounded-[200px] ml-[1.5vw]">编辑资料</div>
            <div className="w-[7.7vw] h-[7.7vw] text-[#41495E] text-[2.9vw] font-[800] flex items-center justify-center border-[1px] border-[#CCCCCD] rounded-[200px] ml-[1.5vw]"><Icon icon="ep:arrow-down-bold" color="#41495e" /></div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="w-[92vw] h-[43vw] rounded-[15px] bg-[#fff] mb-[3.7vw]">
            ...
            <div className="flex justify-evenly">
              <div className="w-[27vw] h-[28vw] rounded-[15px] bg-gradient-to-b from-[#ffdfd3] to-[#FEFEFB] border-[1px] border-[#F6F4F0] relative">
