...
const Login = () => {
  ...
  return (
    <div className="bg-[#fdfbfc] h-[100vh] pb-[12vw]">
      ...
      <img src="https://admirable-jalebi-ce44af.netlify.app/static/logo.fill.svg" alt="" className="w-[38vw] mx-auto mt-[7vw] mb-[9vw]" />
      ...
      <div className="fixed bottom-0">
        <img src="https://admirable-jalebi-ce44af.netlify.app/static/bg-login.png" alt="" className="w-[100vw]" />
      </div>
    </div>
  )
}
