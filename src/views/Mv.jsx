          ...
          <div className="tablist">
            {
              areaArr.map((item, index) => (
                <div
                  ...
                  style={{ color: `${selectArea === item ? "#000" : "#9599a3"}`, borderBottom: `${selectArea === item ? ".8vw solid #ee0a24" : "none"}` }}
                >
                  {item}
                </div>
              ))
                ...
                <div key={index}>
                  <div className="pane_img">
                    ...
                    <div>
                      ...
                      {
                        parseInt(item.playCount / 100000000) > 1 ? (parseInt(item.playCount / 100000000) + "亿") : (parseInt(item.playCount / 10000) > 10 ? (parseInt(item.playCount / 10000) + "万") : (parseInt(item.playCount)))
                      }
                    </div>
                  </div>
                  <div className="h-[15vw] flex flex-col justify-around">
                    <div>
                      <span className="w-[5.3vw] text-[4.3vw] mr-[2.8vw] ml-[1.6vw] text-center" style={{ color: `${index < 3 ? "red" : "#999"}` }}>
                        {index + 1}
                      </span>
                    ...
                    <div className="flex items-center">
                      <div className="w-[5.3vw] text-[#999] text-[2vw] mr-[2.8vw] flex items-center justify-center">
                        <Icon icon="teenyicons:triangle-solid" color="#f05357" width="1.866667vw" />
                        1
                      </div>
