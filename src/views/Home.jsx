...
const StyledDiv = styled.div`
  ...
  .song {
    ...
    align-items: center;
    padding: 0 4vw;    
    border-top: .266667vw solid rgba(224, 224, 224, 0.668);
    .icon-gengduo {
      font-size: 3vw;
      color: #000000;
      font-weight: bold;
    ...
    <StyledDiv>
      <div className="page">
        ...
        <div className="nav">
          ...
          <span className="iconfont icon-maikefeng"></span>
        </div>
      </div>
      <Banner dataImg={page} />
      <Nav></Nav>
      ...
      <div className="w-[100%] h-[6.32vw] bg-[#f1f1f1]"></div>
    </StyledDiv>
  )
}
